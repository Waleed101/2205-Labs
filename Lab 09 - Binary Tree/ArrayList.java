...
public class ArrayList<E> implements List<E> { // ArrayList class impementing the List interface defined elsewhere
    public static final int CAPACITY = 10; // Setting default starting capacity
    ...
    public void add(int i, E e) throws IndexOutOfBoundsException, IllegalStateException { // Function to add element 
    ...
    public Iterator<E> iterator() { // Allowing array iterator 
